...
classes = ['Актинический кератоз', 'Базалиома', 'Доброкачественный кератоз',
           'Дерматофиброма', 'Меланомоопасные невусы', 'Меланома', 'Сосудистые поражения']
...
def model_predict(img):
    ...
    #print(f'pred = {pred_class}, out = {pred_probs}')
    ...
    if val <= 50:
        ...
        pred_class = "Обратитесь к специалисту"
